        ...
        headers: [
          {
            ...
            value: isDev
              ? [
                  // Development CSP: allow inline scripts and eval for ease of dev
              ...
              : [
                  // Production CSP: strict hashes + trusted domains, no unsafe-inline
                  `default-src 'self' data: blob: https:;`,

                  // List of script hashes and allowed script domains
                  `script-src 'self' ` +
